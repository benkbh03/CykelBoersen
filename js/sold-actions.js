  ...
  function showBuyerPickerModal(bikeId, buyers) {
    ...
    el.innerHTML = `
      <div style="position:relative;background:#fff;border-radius:16px;padding:24px;max-width:400px;width:100%;font-family:var(--font-sans);box-shadow:0 8px 40px rgba(0,0,0,0.18);">
        ...
        <h3 style="font-family:var(--font-sans);font-weight:var(--weight-heavy);letter-spacing:-0.02em;margin:0 0 6px;font-size:1.2rem;padding-right:32px;">Hvem købte cyklen?</h3>

    ...
    <div class="bd-page">
      ...
      <div class="bd-form">
        ...
        <div class="form-grid" style="grid-template-columns:1fr 1fr;">
          ...
          <div class="form-group"><label>Telefon</label><input type="tel" inputmode="tel" id="dealer-phone" placeholder="f.eks. 12 34 56 78" maxlength="20" autocomplete="tel" data-1p-ignore="true" data-lpignore="true" data-form-type="other" data-bwignore="true" oninput="this.value=this.value.replace(/[^\d +]/g,'')" onkeydown="if(event.key==='Enter')submitDealerApplication()"></div>

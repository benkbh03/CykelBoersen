import { iconShield, iconBike, iconMail } from './utils.js';
    ...
    <div style="background:#F5F0E8;border-radius:18px;max-width:420px;width:100%;padding:32px 28px 24px;position:relative;box-shadow:0 12px 40px rgba(26,26,24,0.22);">
      ...
      <div style="display:flex;flex-direction:column;gap:14px;margin-bottom:28px;">
        <div style="display:flex;align-items:flex-start;gap:14px;">
          <span style="line-height:1;margin-top:1px;color:var(--forest);">${iconSearch(20)}</span>
          <div>
        ...
        <div style="display:flex;align-items:flex-start;gap:14px;">
          <span style="line-height:1;margin-top:1px;color:var(--forest);">${iconMail(20)}</span>
          <div>

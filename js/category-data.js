...
export const CATEGORY_META = {
  ...
  'el-cykler': {
    ...
    faq: [
      { q: 'Hvad skal jeg tjekke ved en brugt el-cykel?', a: 'Batteriet er det dyreste at udskifte, så spørg om alder, antal opladninger og resterende kapacitet. Tjek også motorens kilometertal, om der er kvittering/garanti, og om bremser og gear fungerer. Se vores blogguide "Køb brugt el-cykel: 7 ting du skal tjekke".' },
  ...
  ladcykler: {
    ...
    faq: [
      { q: 'To eller tre hjul på en ladcykel?', a: 'Trehjulede (kassecykler som Christiania og Babboe) står selv og er stabile ved lav fart. Det er trygt med børn. Tohjulede (long john som Bullitt) er hurtigere og lettere at manøvrere i trafik, men kræver lidt tilvænning. Vælg efter last, afstand og komfort.' },
  ...
  gravelbikes: {
    ...
    intro: 'Gravelbiken er den alsidige alt-terræn-racer med bredere dæk og mere afslappet geometri end en racer, men hurtigere end en MTB. Den kan det hele: grusveje, skovspor, pendling og bikepacking. På Cykelbørsen finder du brugte og nye gravelbikes med gravel-specifikke gruppesæt som Shimano GRX og SRAM Apex/XPLR. Filtrér på gruppesæt, rammemateriale og pris.',
    faq: [
